...
router.post('/create', [
    ...
    try {
        ...
        // Ensure totalCost defaults to 0 if no rows are found
        const totalCost = totalCostForParts[0].totalCost || 0;

        // Calculate the total amount
        const totalAmount = parseFloat(totalCost) + parseFloat(advanceAmount) + parseFloat(labourCost);

        // Log values for debugging
        console.log(`Total Cost for Parts: ${totalCost}`);
