...
const jobCustomerProductRoutes = require("./routes/customerJobandProduct"); // Import the new route
const uploadRoutes = require("./routes/uploadRoutes")
const dashboardRoutes = require("./routes/dashboardRoutes"); // Import the new route
const authRoutes = require("./routes/authRoutes"); // Import the new route
const reportRoutes = require("./routes/reportRoutes"); // Import the new route for reports
...
app.use('/api/jobCustomerProduct', jobCustomerProductRoutes); 
app.use('/api', uploadRoutes)
app.use('/api/dashboard', dashboardRoutes);
app.use('/api/reports', reportRoutes); // Use the new route for reports
app.use('/api/auth', authRoutes); // Use the new route for authentication  
